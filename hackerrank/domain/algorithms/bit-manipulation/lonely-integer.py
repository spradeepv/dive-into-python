...
The first line of the input contains an integer NN, indicating the number of
integers. The next line contains NN space-separated integers that form the
array AA.
...
answer.
In the second input, we see three elements; 1 occurs at two places and 2
only once. Thus, the answer is 2.
